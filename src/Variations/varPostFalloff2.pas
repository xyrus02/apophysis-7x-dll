...
procedure TVariationPostFalloff2.GetCalcFunction(var fun: TCalcFunction);
begin
...
begin
  ...
  FPx^ := VVAR * (in_x + mul_x * random * dist);
  FPy^ := VVAR * (in_y + mul_y * random * dist);
  FPz^ := VVAR * (in_z + mul_z * random * dist);
